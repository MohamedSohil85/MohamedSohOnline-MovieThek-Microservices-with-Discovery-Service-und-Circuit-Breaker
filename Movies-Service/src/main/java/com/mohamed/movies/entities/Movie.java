package com.mohamed.movies.entities;

import com.mohamed.movies.entities.MovieDetials;
import com.mohamed.movieticketsystem.entities.Genre;
...
public class Movie implements Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getMovieId(), getMovieName(), getReleaseDate(), getGenre(), getPrice(),  getRating(), getMovieDetials());
    }
